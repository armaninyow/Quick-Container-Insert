...
public class QuickContainerInsertClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		// Register renderers for containers with no vanilla BlockEntityRenderer.
		// These render nothing normally; during a QCI animation they re-render
		// the block model with the wobble transform applied on top.
